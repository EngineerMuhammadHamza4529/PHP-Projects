      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <h2 class="mb-3">What is Business Law?</h2>
...
<p>Business law plays the role of a foundation stone for any business concern. Establishing business includes a lot of legal processes, leasing, and permits. A business law attorney is well-versed with all the relevant regulations, and can help the concern establish its operations successfully.</p>
<h2 class="mb-3 mt-5">How Can We Help !</h2>
            <p>Whether you're in the process of starting a new business or need help with an ongoing business, or have questions, Our Attorneys Our Always Ready To Help you! .</p>
            <div class="row mt-5 pt-5">
            	...
            	<div class="col-lg-6">
        <?php
        // Fetch the lawyer with user_id = 14
        $user_id = 15;
