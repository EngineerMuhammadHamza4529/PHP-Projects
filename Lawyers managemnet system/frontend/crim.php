      ...
      <section class="ftco-section ftco-degree-bg">
         ...
         <div class="row">
            <div class="col-lg-8 ftco-animate">
               <p>
                  <img src="images/crim.jpg" alt="" class="img-fluid">
               </p>
               <h2 class="mb-3">What is Criminal Law?</h2>
               <p>
               ...
               <p>Criminal Law is an extreme field of practice coverning all those aspects that entail crime as its factor. Every act or omission that violates a command, derives its force from legislature or from authority - either political or religious - that has absolute sway over the matters of state is considered to be a crime. This is the reason that state stands as a prosecutor against the alleged culprit.</p>
