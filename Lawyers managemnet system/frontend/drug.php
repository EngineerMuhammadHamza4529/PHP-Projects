      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
          	<p>
              <img src="images/drug.jpg" alt="" class="img-fluid">
            </p>
            <h2 class="mb-3">What is Drug Offense?</h2>
<p>
...
It is illegal to possess, supply and produce controlled drugs. It is also illegal to import or export drugs, or to allow your premises to be used for drug production.</p>
<p>
