    ...
    <section class="ftco-section ftco-degree-bg">
      <div class="container">
        <div class="row">
          ...
          <p>
              <img src="images/emp.jpg" alt="" class="img-fluid">
            </p>
            <h2 class="mb-3">What is Employment Law?</h2>
            <p>
<p>
Employment law is the set of laws and rules that regulate relationships between employers and employees, these laws compliment in smooth running of the business with regard to matters relating to employment for achieving the target of higher productivity, reasonable profits, better earnings and reduction in unjust practices or discrimination.
</p>
<p>The relationship between an employer and an employee in the workplace is delicate but fundamental. This relationship can define the employee's experience in the workplace and the success of the employer.
When an employer wants to hire someone, there’s a lot they have to know. There are minimum wage laws that require the employer to pay a certain amount. There are laws that prohibit the employer from discriminating against applicants or employees based on certain characteristics. Employers must provide a safe working environment. In some cases, they must provide health insurance options. Employers must collect and submit payroll taxes on behalf of the employee.</p>
        ...
        if ($fetch = mysqli_fetch_array($select)) {
            ...
            // Check if user is logged in by checking if uId is set and not empty
            if (isset($_SESSION['uId']) && !empty($_SESSION['uId'])) {
            ...
            // Optionally, handle the case where no lawyer with user_id = 14 is found
