      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
          	<p>
              <img src="images/fam.jpg" alt="" class="img-fluid">
            </p>
            <h2 class="mb-3">What is Family Law?</h2>
            <p>Family law is a legal practice area that focuses on issues involving family relationships such as marriage, adoption, divorce, and child custody, among others. Attorneys practicing family law can represent clients in family court proceedings or in related negotiations. They can also draft important legal documents such as court petitions or property agreements.</p>
            <p>Some family law attorneys even specialize in adoption, paternity, emancipation, or other matters not usually related to divorce. The matter of family encompasses so many life aspects. Lawyers in the field, therefore, help all kinds of people facing all kinds of sensitive issues that many people wouldn't immediately assume go under the family law umbrella.</p>
            <h2 class="mb-3 mt-5">How Can We Help !</h2>
            <p>Whether you're in the process of a divorce, need help with an adoption, or have questions about enforcing a child support order, Our Attorneys Our Always Ready To Help you! .</p>
