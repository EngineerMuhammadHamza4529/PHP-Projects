   ...
   <div class="container">
      <div class="row mb-5">
         <div class="col-md">
            <div class="ftco-footer-widget mb-4">
               <h2 class="logo"><a href="#">Online <span>Lawyers Application</span></a></h2>
               ...
               <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                  ...
                  <li class="ftco-animate"><a href="https://www.facebook.com/login/"><span class="icon-facebook"></span></a></li>
         ...
         <div class="col-md">
            <div class="ftco-footer-widget mb-4">
               ...
               <div class="block-23 mb-3">
                  <ul>
                     <li><span class="icon icon-map-marker"></span><span class="text">SD-1, Block A North Nazimabad Town, Karachi, Pakistan</span></li>
                     <li><a href="#"><span class="icon icon-phone"></span><span class="text">+92325-7662005</span></a></li>
                     <li><a href="#"><span class="icon icon-envelope"></span><span class="text">info@lawyer.com</span></a></li>
                  </ul>
               </div>
            </div>
         </div>
      ...
      <div class="row">
         <div class="col-md-12 text-center">
            <p>
               Lawyers &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved
            </p>
         </div>
      </div>
   </div>
