            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="departmentinsert.php">
                    <div class="form-group">
                      <label for="exampleInputName1">Department Name</label>
                      <input type="text" name="dep_name" class="form-control" id="exampleInputName1" placeholder="Enter Department Name">
                    </div>
                    <input type="submit"  name="dept_submit" class="btn btn-primary mr-2"/>
                    <a href='../tables/showde.php' ><input type="button" value="VIEW" class="btn btn-light"/></a> 
                  </form>
                </div>
              </div>
            </div>
