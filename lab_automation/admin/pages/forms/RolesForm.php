            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="roleinsert.php">
                    <div class="form-group">
                      <label for="exampleInputName1">Role Name</label>
                      <input type="text" name="role" class="form-control" id="exampleInputName1" placeholder="Enter Role Name">
                    </div>
                    <input type="submit" name="rol_submit" class="btn btn-primary mr-2"/> 
                    <a href='../tables/showroles.php' ><input type="button" value="VIEW" class="btn btn-light"/></a> 
                  </form>
