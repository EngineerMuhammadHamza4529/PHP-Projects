...
$q1="SELECT * FROM products where status='Approve'";
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="shipmentinsert.php">
                  <div class="form-group">
                  <label>Select Product</label>
                    <select name="Prod" class="js-example-basic-single w-100">
                       <?php while ($data1=mysqli_fetch_assoc($rows1)) {?>
                      <option value="<?php echo $data1['ProductID']?>"><?php echo $data1['ProductName']?></option>
                      <?php }?>
                    </select>    
                  </div>
                  <div class="form-group">
                  ...
                  <label>Select Market</label>
                    <select name="market" class="js-example-basic-single w-100">
                     ...
                     <option value="<?php echo $data['MarketID']?>"><?php echo $data['MarketName']?></option>
                     <?php }?>
                    </select>    
                  </div>
                    <input type="submit" name="ship_submit" class="btn btn-primary mr-2"/>
