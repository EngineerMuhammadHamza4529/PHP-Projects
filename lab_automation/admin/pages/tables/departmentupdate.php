                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="">
                    <div class="form-group">
                      ...
                      <input type="text" name="dep_name" class="form-control" id="exampleInputName1" value="<?php echo $data['DepartmentName']; ?>" placeholder="Enter Department Name">
                    </div>
                    <input type="submit"  name="dept_up" class="btn btn-primary mr-2"/>
