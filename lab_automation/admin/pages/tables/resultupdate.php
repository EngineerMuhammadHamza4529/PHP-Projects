...
include('tablesheader.php');
 $id=$_GET['eyeD'];
 $q="select * from result where resultID='$id' ";
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="resultinsert.php" method="POST">
                  <div class="form-group">
                    <label>Select Department</label>
                    <select class="js-example-basic-single w-100" name="prod">
                  ...
                  <div class="form-group">
                      <label for="exampleTextarea1">Result description</label>
                      <textarea class="form-control" value="<?php echo $data['ProductStatus']; ?>" name="sts" id="exampleTextarea1" rows="4"></textarea>
                    </div>
                    <input type="submit" name="res_up" class="btn btn-primary mr-2"/>
...
include('Connect.php');
if(isset($_POST['res_up']))
{
 $stts=$_POST['sts_name'];
  $q="Update result SET ProductStatus='$dept'where ResultID='$id' ;";
