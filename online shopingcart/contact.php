...
include "connection.php";
  ...
  if(isset($_POST['send']))
  {
    ...
    $contact_query = "INSERT INTO `contact_us`(`username`, `email`, `subject`, `company`, `massage`) VALUES ('$userName','$email','$subject','$company','$message')";
    $contact_form = mysqli_query($cn, $contact_query);
               ...
               <div class="col-md-8">
                 <div class="aa-contact-address-left">
                   <form class="comments-form contact-form" action="contact.php" method='post'>
                    ...
                    <button class="aa-secondary-btn" name="send">Send</button>
                  </form>
                 </div>
               </div>
               <div class="col-md-4">
