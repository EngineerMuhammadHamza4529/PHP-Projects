...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2023 at 01:42 PM
...
INSERT INTO `about_us` (`id`, `heading`, `paragraph`) VALUES
(6, 'Our Service', 'Our Service will help you to not get scammed by buyer or Consumer so There is 0 risk in Auction Table You can Buy As much as you want we will be your Money or Auction Guardian.'),
(7, 'Great Mobile App', 'With Auction Table mobile app you can bid on anything under your fingertips. Our App is on IOS, Android and Windows phones. It is user friendly and light themed app. so feel free to bid as much as you can.');
...
INSERT INTO `billing_detail` (`id`, `first_Name`, `last_name`, `Email`, `phone`, `Address`, `country`, `city`, `district`, `post_code`, `inv`) VALUES
(10, 'hafiz usaid', 'ahmed', 'usaid@gmail.com', '03151248285464', 'nazimabad', '14', 'paris', 'ihihhkl', '2546', 67153),
(11, 'hafiz usaid', 'ahmed', 'usaid@gmail.com', '03151248285464', 'nazimabad', '14', 'paris', 'ihihhkl', '2546', 67153),
(12, 'hafiz usaid', 'ahmed', 'usaid@gmail.com', '03151248285464', 'nazimabad', '14', 'paris', 'ihihhkl', '2546', 67153),
(13, 'hafiz usaid', 'ahmed', 'usaid@gmail.com', '03151248285464', 'nazimabad', '14', 'paris', 'ihihhkl', '2546', 67153),
(14, 'hafiz usaid', 'ahmed', 'usaid@gmail.com', '03151248285464', 'nazimabad', '1', 'paris', 'ihihhkl', '2546', 67153),
(15, 'hafiz usaid', 'ahmed', 'usaid@gmail.com', '03151248285464', 'nazimabad', '1', 'paris', 'ihihhkl', '2546', 67153),
(16, 'hafiz usaid', 'ahmed', 'usaid@gmail.com', '03151248285464', 'nazimabad', '1', 'paris', 'ihihhkl', '2546', 67153),
(17, '', '', '', '', '', '0', '', '', '', 67153),
(18, '', '', '', '', '', '0', '', '', '', 96905),
(19, '', '', '', '', '', '0', '', '', '', 96905),
(20, '', '', '', '', '', '0', '', '', '', 96905),
...
INSERT INTO `cart` (`id`, `user_id`, `prd_id`, `quantity`, `status`) VALUES
(151, 0, 17, 1, 0),
(152, 0, 16, 1, 0),
(153, 0, 9, 1, 0),
(154, 0, 9, 1, 0),
...
INSERT INTO `credit_card` (`user_id`, `card_number`, `cvc`, `expiry_date`, `Balance`) VALUES
(1, '2541 2365 7856 4592', '592', '2021-01-01', '35000');
...
CREATE TABLE `order_details` (
  ...
  `companyName` varchar(200) NOT NULL DEFAULT 'N/A',
  `email` varchar(200) NOT NULL,
  `phone` varchar(200) NOT NULL,
  `address` varchar(200) NOT NULL,
  `country` varchar(200) NOT NULL,
  `appartment` varchar(200) NOT NULL DEFAULT 'N/A',
  `city` varchar(200) NOT NULL,
  `district` varchar(200) NOT NULL DEFAULT 'N/A',
...
INSERT INTO `order_details` (`firstName`, `lastName`, `companyName`, `email`, `phone`, `address`, `country`, `appartment`, `city`, `district`, `zip`, `paymentMethod`, `price`, `totalAmount`, `quantity`, `productId`, `userId`, `orderId`) VALUES
('Usama', 'Riaz', 'Axiom', 'usamariz1997@gmail.com', '03122646835', 'P.G block J, Denmark', '8', 'Hermain Apratments', 'Karachi', 'South East', 74600, 'Cash Delivery', 1000, 3450, 1, 1800002, 1, 5),
('Usama', 'Riaz', 'Axiom', 'usamariz1997@gmail.com', '03122646835', 'P.G block J, Denmark', '8', 'Hermain Apratments', 'Karachi', 'South East', 74600, 'Cash Delivery', 400, 3450, 3, 1800005, 1, 6),
('Usama', 'Riaz', 'Axiom', 'usamariz1997@gmail.com', '03122646835', 'P.G block J, Denmark', '8', 'Hermain Apratments', 'Karachi', 'South East', 74600, 'Cash Delivery', 400, 3450, 3, 1800005, 1, 7),
('', '', '', '', '', 'Address*', '0', '', '', '', 0, 'Paypal', 4444, 4494, 1, 1800001, 0, 8),
('Taimoor', 'Ahmed', 'aaaa', 'ta1707243@gmail.com', '03082384748', 'Address*wwgheytw7bvhdb', '16', 'sssssss', 'Asbury Park', 'ssss', 7712, 'Cash Delivery', 550, 600, 1, 9, 0, 9),
('Taimoor', 'Ahmed', 'aaaa', 'ta1707243@gmail.com', '03082384748', 'Address*n', '16', 'sssssss', 'Asbury Park', 'ssss', 7712, 'Cash Delivery', 550, 1150, 1, 9, 8, 10),
('Taimoor', 'Ahmed', 'aaaa', 'ta1707243@gmail.com', '03082384748', 'Address*n', '16', 'sssssss', 'Asbury Park', 'ssss', 7712, 'Cash Delivery', 550, 1150, 1, 13, 8, 11),
('yyy', 'Ahmed', 'ddd', 'ta1707243@gmail.com', '03082384748', 'Address*dddddd', '16', 'ddddd', 'Asbury Park', 'dddd', 7712, 'Cash Delivery', 550, 600, 1, 9, 8, 12);

-- --------------------------------------------------------

--
-- Table structure for table `paymrnt_history`
--

CREATE TABLE `paymrnt_history` (
  `user_id` int(11) NOT NULL,
  `card_number` varchar(50) NOT NULL,
  `cvc` varchar(50) NOT NULL,
  `expiry_date` varchar(32) NOT NULL,
  `date and time` datetime NOT NULL,
  `payed_amount` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `paymrnt_history`
--

INSERT INTO `paymrnt_history` (`user_id`, `card_number`, `cvc`, `expiry_date`, `date and time`, `payed_amount`) VALUES
(1, '2541 2365 7856 4592', '592', '2021-01-01', '0000-00-00 00:00:00', '1000'),
(1, '2541 2365 7856 4592', '592', '2021-01-01', '0000-00-00 00:00:00', '1000'),
(1, '2541 2365 7856 4592', '592', '2021-01-01', '2020-12-28 08:48:10', '1000'),
(1, '2541 2365 7856 4592', '592', '2021-01-01', '2020-12-28 08:51:01', '1000'),
(1, '2541 2365 7856 4592', '592', '2021-01-01', '2020-12-28 08:51:54', '1000'),
(1, '2541 2365 7856 4592', '592', '2021-01-01', '2020-12-28 08:52:16', '1000'),
(1, '2541 2365 7856 4592', '592', '2021-01-01', '2020-12-28 12:52:59', '1000'),
(1, '2541 2365 7856 4592', '592', '2021-01-01', '2020-12-28 12:54:01', '1000'),
(1, '2541 2365 7856 4592', '592', '2021-01-01', '2020-12-28 01:22:40', '1000'),
(1, '2541 2365 7856 4592', '592', '2021-01-01', '2020-12-28 01:23:51', '1000'),
(1, '2541 2365 7856 4592', '592', '2021-01-01', '2020-12-28 06:17:17', '1000'),
(1, '2541 2365 7856 4592', '592', '2021-01-01', '2020-12-28 06:18:44', '1000'),
(1, '2541 2365 7856 4592', '592', '2021-01-01', '2020-12-28 06:19:51', '1000'),
(1, '2541 2365 7856 4592', '592', '2021-01-01', '2020-12-28 06:19:51', '1000'),
(1, '2541 2365 7856 4592', '592', '2021-01-01', '2020-12-28 06:19:51', '1000'),
(1, '2541 2365 7856 4592', '592', '2021-01-01', '2020-12-28 06:21:24', '1000');
...
INSERT INTO `role` (`id`, `user_type`) VALUES
(1, 'Admin'),
(2, 'Employee'),
(3, 'User');
...
INSERT INTO `shipping_address` (`id`, `first_Name`, `last_name`, `Email`, `phone`, `Address`, `country`, `city`, `district`, `post_code`, `inv`) VALUES
(2, '', '', '', '', '', '0', '', '', '', '58003'),
(3, '', '', '', '', '', '0', '', '', '', '58003'),
(4, '', '', '', '', '', '0', '', '', '', '58003'),
(5, '', '', '', '', '', '0', '', '', '', '58003'),
...
INSERT INTO `sign_up` (`id`, `Name`, `Email`, `Password`, `user_role`) VALUES
(1, 'Hafiz Usaid Ahmed', 'usaid@gmail.com', '202cb962ac59075b964b07152d234b70', '1'),
(7, '', '', 'd41d8cd98f00b204e9800998ecf8427e', ''),
(8, 'Taimoor', 'ta1707243@gmail.com', '202cb962ac59075b964b07152d234b70', '1');
...
INSERT INTO `tbl_order` (`ID`, `user_id`, `prd_id`, `quantity`, `inv`, `status`) VALUES
(38, 1, 1800005, 1, 64382, 0),
(39, 1, 1800005, 1, 64382, 0),
(40, 1, 1800002, 1, 64382, 0),
(43, 1, 1800004, 1, 64382, 0),
(44, 1, 1800002, 1, 64382, 0),
(45, 1, 1800005, 1, 64382, 0),
(46, 1, 1800005, 1, 64382, 0),
(47, 1, 1800002, 1, 64382, 0),
(50, 1, 1800004, 1, 64382, 0),
(51, 1, 1800002, 1, 64382, 0),
(52, 1, 1800005, 1, 64382, 0),
(53, 1, 1800005, 1, 64382, 0),
(54, 1, 1800002, 1, 64382, 0),
(55, 1, 1800002, 2, 34136, 0),
(56, 1, 1800002, 2, 62705, 0),
(57, 1, 1900003, 2, 30674, 0);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_prd_category`
--

CREATE TABLE `tbl_prd_category` (
  `code` int(11) NOT NULL,
  `prd_category` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_prd_category`
--

INSERT INTO `tbl_prd_category` (`code`, `prd_category`) VALUES
(15, 'Dolls'),
(11, 'Files'),
(18, 'Gift Articles'),
(12, 'GREETING CARDS'),
(16, 'Hand Bags '),
(14, 'Men beauty products'),
(19, 'Wallets '),
(13, 'Women beauty products');
...
INSERT INTO `tbl_product` (`prd_id`, `prd_name`, `prd_title`, `prd_description`, `prd_price`, `prd_cat`) VALUES
(9, 'Birthday card', 'Cards', 'Designed specifically for birthdays, these cards often feature colorful designs', 550, '12'),
(10, 'Sketchbooks ', 'Artist', 'Sketchbooks and drawing pads are essential tools for artists, illustrators, designers', 400, '18'),
(13, 'Sketchbooks and Drawing Pads', 'Paints', 'Paints are pigmented liquids or substances that are used to add color to various surfaces', 550, '18'),
(15, 'Barbie dolls', 'Dolls', ' Barbie dolls are a popular line of fashion dolls produced by the American toy company Mattel', 4000, '15'),
(16, 'Mens Cleansers', 'Men', 'Facial cleansers or face washes to remove dirt and impurities from the skin', 5555, '14'),
(17, 'Leather Wallets', 'Wallet', ' These classic wallets come in various colors and designs', 700, '19'),
(18, 'Hand Bags', 'Bags', 'A tote bag is a versatile and popular ', 6000, '16'),
(19, 'Moisturizers', 'Women', 'To keep the skin hydrated and prevent dryness', 3000, '13'),
(20, 'American Girl dolls', 'Dolls', '', 2000, '15');
...
--
-- Indexes for table `tbl_prd_category`
--
ALTER TABLE `tbl_prd_category`
  ADD PRIMARY KEY (`code`),
  ADD UNIQUE KEY `prd_category` (`prd_category`);
...
--
-- AUTO_INCREMENT for table `tbl_prd_category`
--
ALTER TABLE `tbl_prd_category`
